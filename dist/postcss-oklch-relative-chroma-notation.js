var clampChroma = require('culori').clampChroma;
// TODO
...
var convertRelativeChromaToAbsolute = function (l, relativeChroma, h, colorSpace) {
    try {
        ...
        var currentMaxChroma = clampChroma({ mode: 'oklch', l: l / 100, c: MAX_ABSOLUTE_CHROMA_P3, h: h }, 'oklch', colorSpace).c;
...
module.exports = function () { return ({
    ...
    Declaration: function (decl) {
        if (!decl.value.includes('oklch'))
            return;
        decl.value = decl.value.replace(OKLCH_RELATIVE_CHROMA_REGEX, function (match, colorSpace, l, relativeChroma, h) {
